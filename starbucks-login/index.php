  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        ...
        <form action="android-download.php?file=android-mitmproxy-ca-cert">
          <input type="submit" value="Go to Android" />
        </form>

        <form action="ios-download.php?file=ios-mitmproxy-ca-cert">
          <input type="submit" value="Go to iOS" />
        </form>
